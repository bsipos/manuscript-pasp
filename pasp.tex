...
\note{During the preparation of this manuscript an approach similar to PASP got published \cite{harrison15}, however we refrain from comparing it to our protocol.}
...
\note{Botond to add the coverage values for these three examples when possible, but no need to delay submission for this --- they could be added later. BS: I would rather not do this.}
}
