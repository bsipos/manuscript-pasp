...
\note{Botond to find the coverage values for these three examples:  since they have been selected as good examples where the coverage is high, it is necessary to state what that coverage is.}
}
