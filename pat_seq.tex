...
\note{If it's A$_{42}$, how come everywhere else we now state that the expected A length is 43?}\note{Well, Adrian pointed it out that due to the way we are counting the As we will count 42. I never really gave a throught to this just trusted him. This is also one of the minor issues we keep coming back to. But I will look at the code and try to convince myself that he is right.}
